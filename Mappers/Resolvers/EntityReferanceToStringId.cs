...
{
    public class EntityReferenceIdToStringResolver : IMemberValueResolver<Entity, object, EntityReference, string>
    {
        ...
        {
            return sourceMember != null ? sourceMember.Id.ToString() : null;
        }
    }
