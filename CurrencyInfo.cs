...
namespace Utilities
{
    ...
    {
        public enum Currencies { Syria = 0, UAE, SaudiArabia, Tunisia, Gold, USA };
        ...
        public CurrencyInfo(Currencies currency)
        {
            switch (currency)
            {
                ...
                case Currencies.USA:
                    ...
                    EnglishPluralCurrencyName = "US Dolla";
                    EnglishCurrencyPartName = "US Dolla";
                    EnglishPluralCurrencyPartName = "Halalas";
                    Arabic1CurrencyName = " دولار امريكى";
                    Arabic2CurrencyName = " دولار امريكى";
                    Arabic310CurrencyName = " دولار امريكى";
                    Arabic1199CurrencyName = "دولار امريكى";
                    Arabic1CurrencyPartName = "هللة";
                    Arabic2CurrencyPartName = "هللتان";
                    Arabic310CurrencyPartName = "هللات";
                    Arabic1199CurrencyPartName = "هللة";
